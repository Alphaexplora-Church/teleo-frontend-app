...
import { useRegisterViewModel } from "./useRegister"
import { useOtpViewModel } from "./useOtp"
...
export function EmailForm({ formData, setFormData, errors }: EmailFormProps) {
  return (
    <form>
      <FieldGroup>
        <FieldLabel>Email</FieldLabel>
...
export function ProfileForm({ formData, setFormData, errors, setErrors }: ProfileFormProps) {
  return (
    <div className="space-y-6">
      <NameForm formData={formData} setFormData={setFormData} errors={errors} />
      <BirthdayForm formData={formData} setFormData={setFormData} errors={errors} />
      <GenderForm formData={formData} setFormData={setFormData} errors={errors} />
      <UsernameForm formData={formData} setFormData={setFormData} errors={errors} />
      <LocationForm formData={formData} setFormData={setFormData} errors={errors} />
      <AvatarUploadForm formData={formData} setFormData={setFormData} />
    </div>
  )
}
...
export function OTPForm({ formData, setFormData, errors }: OTPFormProps) {
  const { inputsRef, timeLeft, handleChange, handleKeyDown, resend } =
    useOtpViewModel(formData, setFormData)
