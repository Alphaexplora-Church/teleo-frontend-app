...
import type { Attachment, Chapter } from "./course-detail.model"

const BOTTOM_NAV = [
  { icon: Home, label: "Home", href: "/" },
  { icon: HeartHandshake, label: "Support", href: "/support" },
  { icon: Megaphone, label: "Announcements", href: "/announcements" },
  { icon: BookMarked, label: "Library", href: ROUTES.landing },
  { icon: CircleUser, label: "Profile", href: ROUTES.profile },
] as const
